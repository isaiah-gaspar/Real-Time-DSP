 ...
 */
//octave
int notes[15]={ 1318.51, 1318.51, 1396.91, 1567.98, 1567.98, 1396.91, 1318.51, 1174.66, 1046.5,	1046.5, 1174.66, 1318.51, 1318.51, 1174.66, 1174.66};
//elta = L*notes/Fs = 512/48000*notes
float delta[15] ={14.06410667, 14.06410667, 14.90037333, 16.72512, 16.72512, 14.90037333, 14.06410667, 12.52970667, 11.16266667, 11.16266667, 12.52970667, 14.06410667, 14.06410667, 12.52970667, 12.52970667};
//93Hz*notes*durationtime
float duration[15]={523.1847681, 523.1847681, 554.2938879, 622.174464, 622.174464, 554.2938879, 523.1847681, 466.1050881, 415.2512001, 415.2512001, 466.21050881,523.1847681, 784.7771522, 233.0525441, 466.1050881};
float sample,y,x,A,g,out,count;

float ADSR(float count, float out)
	{
...
void main()
{
   ...
   { 	
    ...
    for (msec = 0; msec < duration[i]; msec++) //Fs/L = 93 Hz
    {
  
        for (sample = 0; sample < SINE_TABLE_SIZE; sample=sample+delta[i])
        {
